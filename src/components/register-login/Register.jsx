          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="inner-input">
              <Input
                ...
                handleChange={handleNameChange}
                value={name}
                error={nameError} // Pass name error to Input component
              />
            </div>
            <div className="inner-input">
              <Input
                ...
                handleChange={handleEmailChange}
                value={email}
                error={emailError} // Pass email error to Input component
              />
            </div>
            <div className="inner-input">
              <div className="password-input">
                <Input
                  ...
                  value={password}
                  error={passwordError} // Pass password error to Input component
                />
                <img
                  className="img-section"
                  src={passwordicon}
